...
// 				return;
	...
	function jumpNormalPage(page){
		$("#submitForm").attr("action", "page/frontdesk/specialService.jsp?page=" + page).submit();
	}
	...
	function jumpInputPage(totalPage){
		...
		if($("#jumpNumTxt").val() != ''){
			...
			$("#submitForm").attr("action", "page/frontdesk/specialService.jsp?page=" + pageNum).submit();
		}else{
			// “跳转页数”为空
			art.dialog({icon:'error', title:'友情提示', drag:false, resize:false, content:'请输入合适的页数，\n自动为您跳到首页', ok:true,});
			$("#submitForm").attr("action", "page/frontdesk/specialService.jsp?page=" + 1).submit();
		}
	}
</script>
<style>
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<s:iterator id="roomOrder" value="roomOrderList" status="status">
						    ...
						    <tr>
						        ...
						        <td>
									<a href="specialServicePop?fyID=<s:property value="#orderNum" />" class="edit">Service</a>
								</td>
						    </tr>
						</s:iterator>
					</table>
