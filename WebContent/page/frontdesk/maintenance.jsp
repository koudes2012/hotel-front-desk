...
<script type="text/javascript">
	...
	function search(){
		$("#submitForm").attr("action", "maintenance").submit();
	}
</script>
<style>
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<s:iterator id="roomInfo" value="roomInfoList" status="status">
						    ...
						    <tr>
						        ...
						        <td>
									<a href="maintenancePop?roomId=<s:property value="#roomId"/>&&roomName=<s:property value="roomName"/>" class="edit">Maintenance</a>
								</td>
						    </tr>
						</s:iterator>
					</table>
